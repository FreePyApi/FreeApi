...
def format_time(timestamp: int = None, format: str = "%Y-%m-%d %H:%M:%S", timezone: str = "UTC") -> dict:
...
def convert_timezone(timestamp: int = None, from_tz: str = "UTC", to_tz: str = "UTC") -> dict:
...
def day_of_week(timestamp: int = None, timezone: str = "UTC") -> dict:
...
def summer_time(timestamp: int = None, timezone: str = "UTC") -> dict:
